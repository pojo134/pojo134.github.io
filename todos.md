...
5. The Drivers list on the betting desk screen did not have it's click areas updated when we fixed the issues with the scrolling. The mouse doesn't match up correctly with the row you click on. 
